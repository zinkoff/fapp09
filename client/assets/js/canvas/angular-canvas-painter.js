...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('../templates/canvas.html',
    '<div class="pwCanvasPaint" style="position:relative"></div><a class="button"  style="position:absolute;top:0;left:0;z-index:999999999999999;">fup</a>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('../templates/color-selector.html',
    '<ul class="pwColorSelector" style="z-index:999999999;"><li ng-repeat="color in colorList track by $index" class="pwColor" ng-class="{\'active\': (selectedColor === color)}" ng-style="{\'background-color\':color}" ng-click="setColor(color)"></li></ul>');
}]);
})();

// controller
// undo
angular.module('pw.canvas-painter').controller('canvasPainterCtrl', function($scope){
